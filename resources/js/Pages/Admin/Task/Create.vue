        ...
        <main class="flex-1 p-6 overflow-auto">
            <div class="mb-6 flex items-center justify-between">
                ...
                <button
                    ...
                    @click="router.visit('/admin/tasks')"
                >
                    Manage Assignments
                </button>
            </div>
...
export default {
    ...
    setup(props) {
        ...
        const isSelected = (employeeId) => form.value.assignedTo.includes(employeeId);
        ...
        const getEmployeeById = (employeeId) => {
            return (
                employees.value.find((employee) => employee.id === employeeId) || {
                    name: "Unknown",
                    initials: "??",
                }
            );
