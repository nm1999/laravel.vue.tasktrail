                ...
                >
                    <span class="flex items-center gap-2">
                        ...
                        <span
                            ...
                            class="inline-flex items-center justify-center rounded-full bg-red-500 px-1.5 py-0.5 text-xs font-bold text-white min-w-[1.25rem]"
                        >
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="flex-1 p-6 overflow-auto">
                <component 
                    ...
                    :unreadCount="page.props.unreadCount ?? 0"
                />
            </div>
        </div>
    </div>
...
// Seed the live count from the server-side prop on first load
liveUnreadCount.value = page.props.unreadCount ?? 0;
